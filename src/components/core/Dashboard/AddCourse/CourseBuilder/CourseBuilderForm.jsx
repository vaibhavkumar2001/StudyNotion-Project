    ...
    <div className='space-y-8 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6'>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
        <div className='flex flex-col space-y-2'>
          ...
          <input 
            id='sectionName'
            placeholder='Add a section to build you course'
            {...register("sectionName", {required:true})}
            className='w-full bg-richblack-700 px-3 py-2 outline-none border-[1px] border-richblack-700 rounded-md text-richblack-5 drop-shadow-[0_1.5px_rgba(255,255,255,0.25)]'
          />
          {errors.sectionName && (
